    ...
    'questions': {
      ...
      isBasic: true,
       basic: [
          ...
          { id: 'speech-recognition', question: 'Web Speech', info: 'Works well in desktop Chrome and Android Chrome. For other desktop browsers you can use a service such as <a href="http://developer.att.com/apis/speech">AT&T&apos;s Speech API</a>. Safari and Internet Explorer also require the Flash fallback for accessing the microphone. This will not work on iOS devices.', value: false },
