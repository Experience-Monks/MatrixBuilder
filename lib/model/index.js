...
var model = {
  ...
  '/': {
    ...
    'questions': {
      ...
      isBasic: true,
      basic: [
          { id: 'stream', question: 'Camera or Microphone', info: 'For unsupported browsers you may, depending on the usecase, be able to use a Flash fallback. This usualy only works for very simple interactions.', value: false },
